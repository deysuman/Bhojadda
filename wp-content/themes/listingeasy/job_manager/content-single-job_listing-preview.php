    ...
    <div class="container">
        <div class="row<?php echo esc_attr($row_class); ?>">
            <div class="content-container span<?php echo (int)$column; ?>">
						...
						<div class="gt3_single_slider_thumbs_wrapper">
							<div class="gt3_single_slider_thumbs">
									...
									foreach ($jl_post_images as $key => $image) {
										...
										$featured_image = wp_get_attachment_url($key);
										if (!empty($featured_image) && $featured_image !== '') {
											echo '<div class="gt3_single_thmb gt3_js_bg_img gt3_single_thmb'. $count .'" data-count="'. $count .'" data-src="'. aq_resize(esc_url($featured_image), 340, 240, true, true, true) .'" data-ratio="'. esc_attr($img_ratio) .'"></div>';
										}					
									}
									?>
				...
				<div class="listing_post_main_content gt3_listing_preview_post">
					<?php

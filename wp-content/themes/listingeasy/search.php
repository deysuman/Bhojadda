                        ...
                        <div class="blog_post_preview">
                            <div class="blog_content">
                                <div class="listing_meta">
                                    ...
                                    <span><?php echo esc_html__("by", 'listingeasy'); ?> <a href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>" class="text-capitalize"><?php echo esc_html(get_the_author_meta('display_name')); ?></a></span>
                                </div>
                        ...
                        <div class="wrapper_404 height_100percent pp_block">
                            <div class="container_vertical_wrapper">
                                <div class="container a-center pp_container">
                                    <h1><?php echo esc_html__('Oops!', 'listingeasy'); ?> <?php echo esc_html__('Not Found!', 'listingeasy'); ?></h1>
                                    <h2><?php echo esc_html__('Apologies, but we were unable to find what you were looking for.', 'listingeasy'); ?></h2>

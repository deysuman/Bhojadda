...
class posts extends WP_Widget
{
    ...
    function __construct() {
        parent::__construct(false, esc_html__('Posts (current theme)', 'listingeasy'));
    }
    ...
    function widget($args, $instance)
    {
        ...
        while ($gt3_wp_query_posts->have_posts()) : $gt3_wp_query_posts->the_post();
            ...
            if (empty($gt3_theme_featured_image_latest)) {
                ...
                $widg_img = '<a href="' . esc_url(get_permalink()) . '" class="recent_posts_img"><img src="' . esc_url(aq_resize($gt3_theme_featured_image_latest[0], "160", "160", true, true, true)) . '" alt="' . get_the_title() . '"></a>';
            }
               ...
               ' . $widg_img . '
                <div class="recent_posts_content'.esc_attr($widget_class).'">
					...
					<div class="recent_post_meta">
                        ...
                        <span>' . esc_html__("by", 'listingeasy') . ' <a href="' . esc_url(get_author_posts_url(get_the_author_meta('ID'))) . '">' . esc_html(get_the_author_meta('display_name')) . '</a></span>
					</div>
    ...
    {
        $defaultValues = array(
            'widget_title' => esc_html__( 'Recent Posts', 'listingeasy' ),
        ...
        <table class="fullwidth">
            ...
            <tr>
                <td><?php echo esc_html__( 'Show post content:', 'listingeasy' ); ?></td>
            ...
            <tr>
                <td><?php echo esc_html__( 'Choose a category or leave checkboxes fields blank to display all items.', 'listingeasy' ); ?></td>
                <td>
            ...
            $args = array(
             ...
             foreach ($categories as $category) {
                ...
                ?><label style="padding:0 5px 5px 0; min-width: calc(50% - 5px); display: inline-block;"><input type='checkbox' class="checkbox" id='<?php echo  $this->get_field_id( 'posts_widget_category' ).'_'.$category->cat_ID; ?>'
                         ...
                         <?php checked( 1,$posts_widget_category_checked ); ?> /><?php echo $category->name; ?></label><?php
             }

...
function kleo_get_required_plugins() {
	...
	$required_plugins = array(
		...
		array(
			...
			'slug'               => 'js_composer',
			// The plugin slug (typically the folder name)
			'version'            => kleo_get_plugin_version( 'js_composer', '5.5.2', $kleo_rem_plugin_transient ),
			// E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'source'             => kleo_get_plugin_src( 'js_composer', '5.5.2' ),
			// The plugin source
			'required'           => true,
			// If false, the plugin is only 'recommended' instead of required
			'force_activation'   => false,
		...
		array(
			...
			'version'            => '1.11.0',
			// E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'source'             => 'https://github.com/Automattic/sensei/archive/version/1.11.0.zip',
			// The plugin source
			'force_activation'   => false,
			// If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' => false,
		...
		array(
			...
			'version'            => kleo_get_plugin_version( 'sq-sidebar-generator', '1.2', $kleo_rem_plugin_transient ), // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'source'             => kleo_get_plugin_src( 'sq-sidebar-generator', '1.2' ), // The plugin source

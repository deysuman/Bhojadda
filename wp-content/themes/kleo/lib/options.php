...
$sections[] = array(
	...
	'fields'     => array(
		array(
			'id'       => 'title_status',
			'type'     => 'switch',
			'title'    => __( 'Show Page Title', 'kleo_framework' ),
			'subtitle' => __( 'Enable or disable Page title display.', 'kleo_framework' ),
			'default'  => '1' // 1 = checked | 0 = unchecked
		),
		array(
...
$sections[] = array(
	...
	'fields'     => array(
		...
		array(
			...
			'type'     => 'select',
			'compiler' => true,
			'title'    => __( 'Profile page sidebar', 'kleo_framework' ),
			'subtitle' => __( 'Select your sidebar to show on profile pages.', 'kleo_framework' ),
			'data' => 'sidebar',
			'default'  => 'default'
		),
		...
		array(
			...
			'type'     => 'select',
			'compiler' => true,
			'title'    => __( 'Group page sidebar', 'kleo_framework' ),
			'subtitle' => __( 'Select your sidebar to show on single group page.', 'kleo_framework' ),
			'data' => 'sidebar',
			'default'  => 'default'
		),
        ...
        array(
			...
			'type'     => 'switch',
			'title'    => __( 'Switch birthday to age', 'kleo_framework' ),
			'subtitle' => __( 'If enabled it will show a age instead birthday', 'kleo_framework' ),
			'default'  => '0' // 1 = checked | 0 = unchecked
		),
        array(
			'id'       => 'bp_birthdate_to_age_field',
			'type'     => 'text',
			'title'    => __( 'Buddypress Birthday field name', 'kleo_framework' ),
            'subtitle' => __( 'The field name should be exactly the same as in Users -> Profile Fields for field that contains the datebox', 'kleo_framework' ),
	...
	$sections[] = array(
		...
		'fields'     => array(
			...
			array(
				...
				'subtitle' => __( 'Select the number of related products to show on product page. Set 0 to disable', 'kleo_framework' ),
				'options'  => array(
				    '0' => '0',
					'3' => '3',
					'4' => '4',
...
$sections[] = array(
	...
	'fields'     => array(
        ...
        array(
            'id'       => 'full_fontawesome',
            'type'     => 'switch',
            'title'    => __( 'Load complete Font Awesome library', 'kleo_framework' ),
            'subtitle' => __( 'By default KLEO uses only selected icons from fontello library, switch to 1 full library', 'kleo_framework' ),
            'options'  => array(
                'off'       => '0',
                'on'        => '1',
            ),
...
$sections[] = array(
	'icon'       => 'el-icon-key',
	'icon_class' => 'icon-large',
	'title'      => '<del>' . __( 'Theme update', 'kleo_framework' ) . '</del>',
	'customizer' => false,
	'desc'       => '<p class="description">' . sprintf( __( 'Deprecated. You need to use Envato Market plugin. Read the tutorial <a href="%s">here</a>.', 'kleo_framework' ), 'https://seventhqueen.com/support/general/article/update-themes-automatically-using-envato-market-plugin' ) . '</p>',
	'fields'     => array(
		array(
			'id'       => 'tf_username',
			'type'     => 'text',
